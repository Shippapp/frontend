...
const Chat = () => {
  const [messages, setMessages] = useState([
    { id: 1, text: 'Hi there!', sender: 'user', className: 'user-message' },
    { id: 2, text: 'Hello! How are you?', sender: 'match', className: 'match-message' },
  ...
  return (
    <div className="chat-container">
        ...
        <Link to='/shipphome' className="return-button">
            ...
            <div className="chat-title-name">Match Name</div>
      ...
      <div className="message-list">
        {messages.map((message) => (
          <div
            key={message.id}
            className={`message ${message.sender === 'user' ? 'user' : 'match'}`}
            style={{
                alignSelf: message.sender === 'user' ? 'flex-end' : 'flex-start',
                backgroundColor: message.sender === 'user' ? '#fff' : '#E87B00',
      ...
      <div className="input-container">
        ...
        <button onClick={handleSendMessage} className="send-button">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_827_1110)">
                <path d="M2.01 21L23 12L2.01 3L2 10L17 12L2 14L2.01 21Z" fill="white"/>
                </g>
                <defs>
                <clipPath id="clip0_827_1110">
